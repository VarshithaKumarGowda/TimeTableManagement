...
public class AddClassActivity extends Activity {
	...
	public void addClass(View v) {
		 boolean done = Database.addClass(this,
				  ...
				  chkAdjust.isChecked());
		 String batchcode = textBatchCode.getText().toString() ;
		 String textclassdate = textClassDate.getText().toString();
		 String textclasstime =textClassTime.getText().toString();
		 String editperiod = editPeriod.getText().toString();
		 String	edittopics = editTopics.getText().toString();
		 String  editremarks = editRemarks.getText().toString();

		if(batchcode.equals("")||textclassdate.equals("")||textclasstime.equals("")||editperiod.equals("")||editremarks.equals("")||edittopics.equals(""))
		{
			Toast.makeText(AddClassActivity.this, "Dont leave the fields bank", Toast.LENGTH_LONG).show();
		} else if ( done )
