...
public class ListClassesActivityTeacher extends Activity {
	...
	private void addRowsToTable(TableLayout table, String batchcode) {
		...
		for(final Class c : classes) {
			TableRow row = (TableRow) LayoutInflater.from(this).inflate(R.layout.classrowteacher, null);
			...
			ImageButton btnUpdate = (ImageButton) row.findViewById(R.id.btnUpdateteacher);
			btnUpdate.setOnClickListener( new OnClickListener() {
				@Override
				public void onClick(View v) {
					Intent intent = new Intent( ListClassesActivityTeacher.this,UpdateClassActivityTeacher.class);
