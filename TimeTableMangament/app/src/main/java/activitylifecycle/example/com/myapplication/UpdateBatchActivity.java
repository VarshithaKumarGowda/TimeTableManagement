...
public class UpdateBatchActivity extends Activity {
	...
	public void updateBatch(View v) {
		...
		String batchcode = editBatchcode.getText().toString();
		...
		if(batchcode.equals("")||course.equals("")||StartTime.equals("")||editperiod.equals("")||editremarks.equals(""))
		{
			Toast.makeText(UpdateBatchActivity.this, "Dont leave the fields bank", Toast.LENGTH_LONG).show();
		}
		else if ( done )
