   ...
   private Button btnRecord, btnPlay , btnStudent;
	...
	public void updateClass(View v) {
		...
		String Remarks = editRemarks.getText().toString();
		 ...
		 if(Topics.equals("")||Remarks.equals("")){
	...
	public void student_manage(View v) {
		...
		Intent i =new Intent(UpdateClassActivity.this,StudentMainActivity.class);
		startActivity(i);
	}
	...
	public void speech_to_text(View v)
	{
		...
		Toast.makeText(this,filenamesent, Toast.LENGTH_LONG).show();
		Intent i =new Intent(UpdateClassActivity.this,Record.class);
		startActivity(i);
	}
